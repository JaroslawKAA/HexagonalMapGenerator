...
namespace PathFinding
{
    ...
    {
        // PRIVATE
        private readonly RuntimeMapLoader _runtimeMapLoader;
        ...
        // PUBLIC
        public Pathfinding(RuntimeMapLoader runtimeMapLoader) => _runtimeMapLoader = runtimeMapLoader;

        public List<PathNode> FindPathOnScreen(Vector2Int start, Vector2Int end)
        {
            PathNode startNode = _runtimeMapLoader.GetTile(start).PathNode;
            PathNode endNode = _runtimeMapLoader.GetTile(end).PathNode;
        ...
        private int CalculateHeuristicDistanceCost(Vector2Int a, Vector2Int b) =>
            Mathf.RoundToInt(MOVE_STRAIGHT_COST *
                             Vector3.Distance(
                                 _runtimeMapLoader.Grid.CellToWorld((Vector3Int)a),
                                 _runtimeMapLoader.Grid.CellToWorld((Vector3Int)b)));
